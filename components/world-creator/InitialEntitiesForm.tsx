                    ...
                    {state.initialFactions.map(faction => {
                        ...
                        return (
                            <div key={faction.id} className="neumorphic-concave rounded-xl overflow-hidden transition-all">
                                ...
                                {isExpanded && (
                                    <div className="p-3 neumorphic-inset space-y-4 animate-fade-in-fast">
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label htmlFor={`faction-rep-${faction.id}`} className="block text-sm font-medium text-neutral-300 mb-2">Danh tiếng</label>
                                            ...
                                            <div>
                                                <label htmlFor={`faction-power-${faction.id}`} className="block text-sm font-medium text-neutral-300 mb-2">Mức độ thế lực</label>
                                ...
                                {isExpanded && (
                                    <div className="p-3 neumorphic-inset space-y-4 animate-fade-in-fast">
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label htmlFor={`npc-faction-${npc.id}`} className="block text-sm font-medium text-neutral-300 mb-2">Thế lực hiện tại</label>
