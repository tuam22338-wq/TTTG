...
const DropletIcon: React.FC<{ className?: string }> = ({ className }) => (<svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path fillRule="evenodd" d="M12.54 22.24a.75.75 0 01-1.08 0l-6.5-6.5a.75.75 0 010-1.06l6.5-6.5a.75.75 0 011.06 0l6.5 6.5a.75.75 0 010 1.06l-6.5 6.5z" clipRule="evenodd" /></svg>);
...
const FoodIcon: React.FC<{ className?: string }> = ({ className }) => (<svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm14.024-4.243a.75.75 0 10-1.06-1.06l-4.5 4.5a.75.75 0 001.06 1.06l4.5-4.5z" clipRule="evenodd" /></svg>);
...
const SwordIcon: React.FC<{ className?: string }> = ({ className }) => (<svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M13.5 3.75a.75.75 0 00-3 0V15a.75.75 0 001.5 0V3.75z" /><path d="M9.75 8.25a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5h-4.5z" /></svg>);
const ShieldIcon: React.FC<{ className?: string }> = ({ className }) => (<svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 00-.189.866c0 .298.059.605.189.866.108.215.395.634.936.634h5.25c.54 0 .828-.419.936-.634.13-.26.189-.568.189-.866s-.059-.605-.189-.866c-.108-.215-.395-.634-.936-.634h-5.25z" clipRule="evenodd" /></svg>);
const MagicShieldIcon: React.FC<{ className?: string }> = ({ className }) => (<svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M6.32 7.841a.75.75 0 011.06 0l4.5 4.5a.75.75 0 01-1.06 1.06L6.32 8.901a.75.75 0 010-1.06z" /><path d="M16.841 6.32a.75.75 0 011.06 0l.75.75a.75.75 0 010 1.06l-4.5 4.5a.75.75 0 01-1.06 0l-.75-.75a.75.75 0 010-1.06l4.5-4.5z" /></svg>);
